    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="../DataUser/datauserlogin.php">Data user</a>
...
//die();
    ...
    ?>
    <h1 class="mt-5" align="center">Data User Login</h1>
        <br>    <br>
  ...
  <div class="form-group row">
   ...
   <button type="button" class="btn btn-danger col align-self-end " style="margin: 10px;">Cancel</button>
        ...
        <div class="form-group row">
            ...
            <a href="datauserregister.php" class="col center" align="center">New Register</a>
   </div>
</form>
