    ...
    <header>
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #11c19f">
                <a class="navbar-brand" href="../index.php">St Peters College</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="../DataUser/datauserregister.php">Data user</a>
...
$do->insertuser1();
  ...
  ?>
    <h1 class="mt-5" align="center">Data User Register</h1>
        <br>    <br>
  ...
  <div class="input-group-prepend">
   ...
   <button type="submit" class="btn btn-danger col align-self-end " name="cancel" style="margin: 10px;">Cancel</button>
         ...
         <div class="form-group row">
             ...
             <a href="datauserlogin.php" class="col center" align="center">Already Registered?click here</a>
   </div>
</form>
  </div>
  </div>
