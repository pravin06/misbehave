...
<main role="main" class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5" align="center">Catch You if You Misbehave: Ranked Keyword Search Results Verification in Cloud Computing</h1>
    <div> <img src='seo.jpg'width="100%">
    
    </div>
    <p class="lead">sadsgfjhkl</p>
  </div>
</main>
